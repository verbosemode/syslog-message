...
(* I've copied this code over from the old QCheck library to preserve the
 * way, strings are generated *)
module QCheck_legacy = struct
(* Copyright (c) 2013, Simon Cruanes *)
(* All rights reserved. *)

(* BSD License. https://github.com/c-cube/qcheck/blob/master/LICENSE *)
(* Source: https://github.com/c-cube/qcheck/blob/master/qCheck.ml *)
